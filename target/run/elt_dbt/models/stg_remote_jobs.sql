  ...
  create or replace   view SNOWFLAKE_LEARNING_DB.PUBLIC.stg_remote_jobs
...
renamed as (
    select
        ...
        cast(annualSalaryMin as float) as salario_min_anual,
        cast(annualSalaryMax as float) as salario_max_anual,
...
final as (
    select
        ...
        senioridade,
        salario_min_anual,
        salario_min_anual / 12 as salario_min_mensal,
        salario_max_anual,
        salario_max_anual / 12 as salario_max_mensal,
        moeda
    from renamed
)
